...
Appraisal gemfiles on this branch already floored Rails to patched 7.2 and 8.1 lines. bundle lock --update=json re-resolved those locks against the already-edited gemfiles. json 2.21.2 and sqlite3 2.9.6 are in the graph. Other WIP files on this branch were left as they were.
